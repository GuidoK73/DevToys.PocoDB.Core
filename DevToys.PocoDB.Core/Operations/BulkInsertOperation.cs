...
namespace DevToys.PocoDB.Core.Operations
{
        ...
        where TINSERTOBJECT : class, new()
    {
        ...
        {
            Type _type = ConnectionFactory.Instance.GetType(Config.ConnectionTypeName);
            
            if (_type == null || _type != typeof(SqlConnection))
        ...
        {
            using (SqlConnection connection = ConnectionFactory.Instance.Create(Config.ConnectionTypeName, Config.ConnectionString) as SqlConnection)
            {
